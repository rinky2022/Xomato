                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group" > 
                                        ...
                                        <input className="form-control" id="name" required name="name" onChange={this.handleChange}/>
                                    </div>
                                </div>
                                <div className="col-md-6" >
                                    <div className="form-group">
                                        <label form="form-control" for="phone">Phone</label>
                                        <input className="form-control" id="phone" name="phone" onChange={this.handleChange}/>
                                    </div>
                                </div>
                                <div className="col-md-6" >
                                    <div className="form-group">
