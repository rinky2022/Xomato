    ...
    conditionalHeader =() =>{
        ...
        if(this.state.userData.name ||  sessionStorage.getItem('uName') !== null)
        {
            if( sessionStorage.getItem('uName') !== null)
            {
                ...
                return(
                    <>
                        <Link className="btn btn-primary" to="/" style={{marginTop:'-5%'}}>
        ...
        return(
            <>
                <a className="btn btn-warning" href="https://github.com/login/oauth/authorize?client_id=49e6d7b92b46fbec4f9a">
                        Login With Github
                    </a> &nbsp;
                <Link className="btn btn-danger" to="/register"><span className="glyphicon glyphicon-user"></span> Sign Up</Link>
                &nbsp;
    ...
    render(){
        return(
            <div className="header">
                ...
                <div>
                    <Link to="/" className="btn btn-danger homeBtn">Home</Link>
                </div>
                <div id="social">
